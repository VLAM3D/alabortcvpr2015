...
#
#     def __init__(self, classifier=LinearSVMLR, parts_shape=(17, 17),
#                  offsets=np.array([[0, 0]]), features=None,
#                  normalize_parts=False, covariance=1, diagonal=None,
...
#                                          show_bar=False)))
#
#                 samples = [i.pixels[:, l, ...] for i in parts_images]
#
#                 clf = self.classifier(samples, mask, **kwargs)
